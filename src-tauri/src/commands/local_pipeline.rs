...
fn log_to_file(msg: &str) {
    ...
    let _ = OpenOptions::new()
        .create(true)
        .append(true)
        .open("/tmp/aivoicehub_pipeline.log")
        .and_then(|mut f| {
...
pub fn start_local_pipeline(
    ...
    let venv_python = format!("{}/Library/Application Support/AIVoiceHub/mlx-env/bin/python3", home);
...
pub fn check_mlx_setup() -> Result<String, String> {
    let home = std::env::var("HOME").unwrap_or_else(|_| "/Users/phucnt".to_string());
    let marker = format!("{}/Library/Application Support/AIVoiceHub/mlx-env/.setup_complete", home);
    let venv_python = format!("{}/Library/Application Support/AIVoiceHub/mlx-env/bin/python3", home);
